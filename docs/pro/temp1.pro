...
idxf('Debugger', 'ListenerDebugger', b, `pug_overview.htm`).
...
idxf('Compiling', 'IntermixingInterpretedandCompi', b, `pug_overview.htm`).
...
idxf('Duck World', 'Debugging', b, `pug_tutorial.htm`).
idxf('Debugging', 'Debugging', b, `pug_tutorial.htm`).
idxf('Tutorial', 'Modules', b, `pug_tutorial.htm`).
idxf('Modules', 'Modules', b, `pug_tutorial.htm`).
idxf('Duck World', 'Modules', b, `pug_tutorial.htm`).
idxf('consult','Modules',b,`pug_tutorial.htm`).
idxf('loc','Modules',b,`pug_tutorial.htm`).
idxf('main','Modules',b,`pug_tutorial.htm`).
...
idxf('main','RunningaModularApplication',b,`pug_tutorial.htm`).
idxf('Tutorial', 'UsingProjectsintheIDE', b, `pug_tutorial.htm`).
idxf('Duck World', 'UsingProjectsintheIDE', b, `pug_tutorial.htm`).
idxf('IDE', 'UsingProjectsintheIDE', b, `pug_tutorial.htm`).
idxf('Compiling', 'Compiling', b, `pug_tutorial.htm`).
...
idxf('Duck World', 'LinkingandEXEGeneration', b, `pug_tutorial.htm`).
idxf('Duck World', 'DistributinganApplication', b, `pug_tutorial.htm`).
...
idxf('Clauses', 'ListingClauses', b, `pug_listener.htm`).
...
idxf('user_pp','ListenerCommands',b,`pug_listener.htm`).
idxf('Predicates', add, b, `pug_listener.htm`).
idxf('debug',debug,b,`pug_listener.htm`).
idxf('Debugger', debug, b, `pug_listener.htm`).
idxf('pp',ppTermuserppTerm,b,`pug_listener.htm`).
idxf('user_pp',ppTermuserppTerm,b,`pug_listener.htm`).
...
idxf('Debugger', 'SourceCodeDebugger', b, `pug_debugger_ide.htm`).
...
idxf('Clauses', 'DebuggerDisplay', b, `pug_debugger_ide.htm`).
...
idxf('Debugging', 'DebuggerExample', b, `pug_debugger_ide.htm`).
idxf('Creep', 'DebuggerExample', b, `pug_debugger_ide.htm`).
idxf('Leap', 'DebuggerExample', b, `pug_debugger_ide.htm`).
idxf('leash','DebuggerExample',b,`pug_debugger_ide.htm`).
idxf('Debugger', 'TheCommandLineDebugger', b, `pug_debugger.htm`).
...
idxf('Clauses', 'DebuggerDisplay', b, `pug_debugger.htm`).
...
idxf('nospyall','Spypoints',b,`pug_debugger.htm`).
...
idxf('writelog','Logging',b,`pug_debugger.htm`).
idxf('nllog','Logging',b,`pug_debugger.htm`).
idxf('closelog','Logging',b,`pug_debugger.htm`).
idxf('Debugging', 'DebuggerExample', b, `pug_debugger.htm`).
idxf('Creep', 'DebuggerExample', b, `pug_debugger.htm`).
idxf('Leap', 'DebuggerExample', b, `pug_debugger.htm`).
idxf('leash','DebuggerExample',b,`pug_debugger.htm`).
idxf('acmp','Compiler',b,`pug_compiler.htm`).
idxf('Compiler', 'Compiler', b, `pug_compiler.htm`).
idxf('Compiling', 'AdvantagesofCompiling', b, `pug_compiler.htm`).
idxf('Compiling', 'DisadvantagesofCompiling', b, `pug_compiler.htm`).
idxf('listing','DisadvantagesofCompiling',b,`pug_compiler.htm`).
idxf('clause','DisadvantagesofCompiling',b,`pug_compiler.htm`).
idxf('Compiling', 'RequirementsonCompiledFiles', b, `pug_compiler.htm`).
idxf('Directives', 'CompilerDirectives', b, `pug_compiler.htm`).
...
idxf('IDE', 'StartingtheCompilerfromtheWind', b, `pug_compiler.htm`).
idxf('Compiler', 'StartingtheCompilerfromtheWind', b, `pug_compiler.htm`).
...
idxf('Compiler', 'StartingtheCompilerfromtheComm', b, `pug_compiler.htm`).
idxf('Compiling', 'CompilerMessages', b, `pug_compiler.htm`).
idxf('Messages', 'CompilerMessages', b, `pug_compiler.htm`).
idxf('Compiling', 'CompilationErrors', b, `pug_compiler.htm`).
idxf('Errors', 'CompilationErrors', b, `pug_compiler.htm`).
idxf('maxclauses','CompilationErrors',b,`pug_compiler.htm`).
idxf('destbuf','CompilationErrors',b,`pug_compiler.htm`).
idxf('srcbuf','CompilationErrors',b,`pug_compiler.htm`).
idxf('Compiling', 'ComplexClauses', b, `pug_compiler.htm`).
idxf('Clauses', 'ComplexClauses', b, `pug_compiler.htm`).
idxf('Compiling', 'ComplexPredicates', b, `pug_compiler.htm`).
...
idxf('IDE', 'StartingtheLinkerfromtheWindow', b, `pug_linker.htm`).
...
idxf('readbuffer','CFGParameters',b,`pug_runtime.htm`).
idxf('readdepth','CFGParameters',b,`pug_runtime.htm`).
idxf('maxvars','CFGParameters',b,`pug_runtime.htm`).
idxf('maxclauses','CFGParameters',b,`pug_runtime.htm`).
...
idxf('string_esc','Flags',b,`pug_runtime.htm`).
...
idxf('prolog_version','Flags',b,`pug_runtime.htm`).
...
idxf('writelog','Logging',b,`pug_debugging.htm`).
...
idxf('user_bugwrite/1', 'DebuggerLikeIO', b, `pug_debugging.htm`).
...
idxf('Debugging', 'DebuggingLogicServerAPIFunctio', b, `pug_debugging.htm`).
...
idxf('define',pound_define,b,`pug_preprocessor.htm`).
idxf('Compiling', 'DynamicClausesinCompiledCode', b, `ref_directives.htm`).
idxf('Clauses', 'DynamicClausesinCompiledCode', b, `ref_directives.htm`).
idxf('dynamic','DynamicClausesinCompiledCode',b,`ref_directives.htm`).
idxf('Compiling', 'MultifileClauses', b, `ref_directives.htm`).
idxf('Clauses', 'MultifileClauses', b, `ref_directives.htm`).
idxf('multifile','MultifileClauses',b,`ref_directives.htm`).
idxf('Compiling', 'DiscontiguousClauses', b, `ref_directives.htm`).
idxf('Clauses', 'DiscontiguousClauses', b, `ref_directives.htm`).
...
idxf('op','Operators',b,`ref_directives.htm`).
idxf('set_prolog_flag/2', 'PrologFlag', b, `ref_directives.htm`).
idxf('Compiling', 'LatentExpressions', b, `ref_directives.htm`).
idxf('Latent Expressions', 'LatentExpressions', b, `ref_directives.htm`).
idxf('op','LatentExpressions',b,`ref_directives.htm`).
...
idxf('Escape Characters', 'EscapeCharacters', b, `ref_terms.htm`).
idxf('Escape Characters', 'EnablingandDisablingEscapeProc', b, `ref_terms.htm`).
idxf('string_esc','EnablingandDisablingEscapeProc',b,`ref_terms.htm`).
idxf('Escape Characters', 'EscapeCodes', b, `ref_terms.htm`).
...
idxf('read_string','WhereEscapeCodesCanbeUsed',b,`ref_terms.htm`).
idxf('Strings', 'Strings', b, `ref_terms.htm`).
idxf('double_quote_strings','Strings',b,`ref_terms.htm`).
idxf('mode','Strings',b,`ref_terms.htm`).
...
idxf(':-','Clauses',b,`ref_execution.htm`).
...
idxf('not/1', notGoal, b, `ref_execution.htm`).
idxf('notnot',notGoal,b,`ref_execution.htm`).
...
idxf('once/1', onceGoal, b, `ref_execution.htm`).
...
idxf('user (module)', 'DefaultUserModule', b, `ref_modules.htm`).
...
idxf(':','ReferringToModules',b,`ref_modules.htm`).
...
idxf('is_list/1', islistX, b, `ref_manipulating_terms.htm`).
...
idxf('==/2', 'EqualityofTerms', b, `ref_manipulating_terms.htm`).
idxf('not(not())', 'EqualityofTerms', b, `ref_manipulating_terms.htm`).
...
idxf('string_query/2', string_query2, b, `ref_manipulating_terms.htm`).
...
idxf('numbervars/3', numbervarsTermStartEnd, b, `ref_manipulating_terms.htm`).
...
idxf('is_member/2', ismember, b, `ref_text.htm`).
...
idxf('is_string/1', is_string, b, `ref_text.htm`).
...
idxf('string_float/2', string_float, b, `ref_text.htm`).
idxf('string_icomp/2', stringicomp, b, `ref_text.htm`).
idxf('string_integer/2', stringintegerStringInteger, b, `ref_text.htm`).
idxf('string_number/2', string_number, b, `ref_text.htm`).
idxf('string_length/2', stringlengthStringLength, b, `ref_text.htm`).
idxf('string_list/2', stringlistStringList, b, `ref_text.htm`).
idxf('string_split/3', stringsplit, b, `ref_text.htm`).
idxf('Parsing', stringsplit, b, `ref_text.htm`).
idxf('string_term/2', stringtermStringTerm, b, `ref_text.htm`).
idxf('string_termq/2', stringtermqStringQTerm, b, `ref_text.htm`).
idxf('string_termq/', stringtermqStringQTerm, b, `ref_text.htm`).
idxf('string_termq',stringtermqStringQTerm,b,`ref_text.htm`).
idxf('is_string_term/2', isstringterm, b, `ref_text.htm`).
idxf('is_string_term/', isstringterm, b, `ref_text.htm`).
idxf('is_string_term',isstringterm,b,`ref_text.htm`).
idxf('string_tokens/2', stringtokens, b, `ref_text.htm`).
idxf('string_tokens/3', stringtokens, b, `ref_text.htm`).
idxf('Parsing', stringtokens, b, `ref_text.htm`).
idxf('string_trim/2', stringtrim, b, `ref_text.htm`).
...
idxf('maximum',maxXY,b,`ref_math.htm`).
...
idxf('mods','XmodsY',b,`ref_math.htm`).
...
idxf('Complement', 'ComplementX', b, `ref_math.htm`).
...
idxf('numeric_type/2', numerictypeNT, b, `ref_math.htm`).
idxf('integer/1', integerN, b, `ref_math.htm`).
idxf('is_fraction/1', is_fraction, b, `ref_math.htm`).
idxf('is_integer/1', isintegerN, b, `ref_math.htm`).
idxf('is_odd/1', is_odd, b, `ref_math.htm`).
idxf('is_number/1', is_number, b, `ref_math.htm`).
...
idxf('is_odd','NotesOnRealsAndGigdigits',b,`ref_math.htm`).
idxf('set_prolog_flag','NotesOnRealsAndGigdigits',b,`ref_math.htm`).
...
idxf(':-dynamic/1', 'DynamicDirective', b, `ref_logicbase.htm`).
...
idxf('user_input','StandardStreams',b,`ref_io.htm`).
idxf('user_output','StandardStreams',b,`ref_io.htm`).
idxf('user_error','StandardStreams',b,`ref_io.htm`).
idxf('user_function','StandardStreams',b,`ref_io.htm`).
idxf('user streams', 'StandardStreams', b, `ref_io.htm`).
...
idxf('mode(stream)', 'StreamProperties', b, `ref_io.htm`).
...
idxf('reading characters', 'StringsAndCharacters', b, `ref_io.htm`).
...
idxf('put/1', putCharputIDChar, b, `ref_io.htm`).
idxf('put/2', putCharputIDChar, b, `ref_io.htm`).
idxf('read_string/1', readstringStringreadstringIDSt, b, `ref_io.htm`).
idxf('read_string/2', readstringStringreadstringIDSt, b, `ref_io.htm`).
...
idxf('tab/2', tabNtabIDN, b, `ref_io.htm`).
...
idxf('set_stream_position/2', 'Repositioning', b, `ref_io.htm`).
idxf('steam_property','Repositioning',b,`ref_io.htm`).
idxf('stream_property/2', stream_property, b, `ref_io.htm`).
idxf('set_stream_position/2', 'SetStreamPosition', b, `ref_io.htm`).
...
idxf('writelog/1', writelogX, b, `ref_io.htm`).
...
idxf('pro_control/2', procontrolTopPos, b, `ref_system.htm`).
...
idxf('Difference Lists, Parsing', 'ParsingWithDifferenceLists', b, `ref_dcg.htm`).
