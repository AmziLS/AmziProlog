...
#
# RCS: @(#) $Id: init.tcl,v 1.1.1.1 2004/05/05 16:04:30 dennis Exp $
#
...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Mar 01, 2004
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.6.0 Win32/x86, Mon Mar 01 11:16:00 PM Pacific Standard Time 2004
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1078211760}
	buildtime,fmt {Mon Mar 01 11:16:00 PM Pacific Standard Time 2004}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.6.0 Win32/x86, Build 93230 @ Mon Mar 01 11:16:00 PM Pacific Standard Time 2004 / normal}
    }
}
